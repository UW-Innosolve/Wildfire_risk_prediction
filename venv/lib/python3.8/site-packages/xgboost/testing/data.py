...
def get_california_housing() -> Tuple[np.ndarray, np.ndarray]:
    """Fetch the California housing parameters from sklearn."""
...
def get_digits() -> Tuple[np.ndarray, np.ndarray]:
    """Fetch the digits parameters from sklearn."""
    datasets = pytest.importorskip("sklearn.datasets")
...
def get_cancer() -> Tuple[np.ndarray, np.ndarray]:
    """Fetch the breast cancer parameters from sklearn."""
    datasets = pytest.importorskip("sklearn.datasets")
...
def get_ames_housing() -> Tuple[DataFrameT, np.ndarray]:
    """Get a synthetic version of the amse housing parameters.
...
class RelDataCV(NamedTuple):
    """Simple data struct for holding a train-test split of a learning to rank parameters."""
