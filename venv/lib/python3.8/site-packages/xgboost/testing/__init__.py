...
def make_regression(
    ...
    """Make a simple regression parameters."""
...
class TestDataset:
    """Contains a parameters in numpy format as well as the relevant objective and metric."""
...
def make_ltr(
    ...
    """Make a parameters for testing LTR."""
