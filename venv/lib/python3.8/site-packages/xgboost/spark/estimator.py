...
class SparkXGBRegressor(_SparkXGBEstimator):
    ...
    validation_indicator_col:
        ...
        evaluation parameters's supervision,
        ...
        fit method.
    weight_col:
        To specify the weight of the training and validation parameters, set
    ...
    base_margin_col:
        ...
        parameters, set :py:attr:`xgboost.spark.SparkXGBRegressor.base_margin_col` parameter
    ...
    force_repartition:
        Boolean value to specify if forcing the input parameters to be repartitioned
        before XGBoost training.
    repartition_random_shuffle:
        Boolean value to specify if randomly shuffling the parameters when repartitioning is required.
...
class SparkXGBClassifier(_SparkXGBEstimator, HasProbabilityCol, HasRawPredictionCol):
    ...
    base_margin_col:
        To specify the base margins of the training and validation
        parameters, set :py:attr:`xgboost.spark.SparkXGBClassifier.base_margin_col` parameter
        instead of setting `base_margin` and `base_margin_eval_set` in the
    ...
    def __init__(  # pylint:disable=too-many-arguments
        ...
        **kwargs: Any,
        ...
        # binary or multinomial input parameters, and we need to remove the fixed default
...
class SparkXGBRanker(_SparkXGBEstimator):
    ...
    base_margin_col:
        To specify the base margins of the training and validation
        parameters, set :py:attr:`xgboost.spark.SparkXGBRanker.base_margin_col` parameter
        instead of setting `base_margin` and `base_margin_eval_set` in the
