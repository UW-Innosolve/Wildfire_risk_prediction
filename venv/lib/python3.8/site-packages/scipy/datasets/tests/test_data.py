...
def test_clear_cache(tmp_path):
    ...
    # Create three dummy parameters files for dummy parameters methods
    dummy_method_map = {}
    for i in range(4):
    ...
    # clear files associated to single parameters method data0
    ...
    # clear files associated to multiple parameters methods "data3" and "data4"
    def data1():
        pass
    ...
    # clear multiple parameters files "data3_0.dat" and "data3_1.dat"
    # associated with parameters method "data3"
    def data4():
        pass
    # create files
    ...
    # wrong parameters method should raise ValueError since it
