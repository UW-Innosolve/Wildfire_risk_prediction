...
class MetaData:
    """Small container to keep useful information on a ARFF parameters.
    ...
    ::
        ...
        # This will print the attributes names of the iris.arff parameters
        for i in meta:
            print(i)
        # This works too
        meta.names()
...
def loadarff(f):
    ...
    meta : `MetaData`
       ...
       type of attributes, the relation (name of the parameters), etc.
