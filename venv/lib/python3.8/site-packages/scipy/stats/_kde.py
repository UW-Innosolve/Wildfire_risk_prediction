...
class gaussian_kde:
    ...
    weights : array_like, optional
        weights of datapoints. This must be the same shape as parameters.
        If None (default), the samples are assumed to be equally weighted

    Attributes
    ----------
    dataset : ndarray
        The parameters with which `gaussian_kde` was initialized.
    d : int
    ...
    factor : float
        ...
        estimation.
    covariance : ndarray
        The covariance matrix of `parameters`, scaled by the calculated bandwidth
        (`kde.factor`).
    inv_cov : ndarray
    ...
    def __init__(self, dataset, bw_method=None, weights=None):
        ...
        if not self.dataset.size > 1:
            raise ValueError("`parameters` input should have multiple elements.")
        ...
        if self.d > self.n:
            msg = ("Number of dimensions is greater than number of samples. "
                   ...
                   "*column* of `parameters` to be a point; consider transposing "
                   "the input to `parameters`.")
    ...
    def evaluate(self, points):
        ...
        if d != self.d:
            if d == 1 and m == self.d:
                ...
                msg = "points have dimension %s, parameters has dimension %s" % (d,
                    self.d)
                raise ValueError(msg)
    ...
    def resample(self, size=None, seed=None):
        """Randomly sample a parameters from the estimated pdf.
    ...
    def inv_cov(self):
        ...
        # used in the wild. (Perhaps users change the `parameters`, since it's
        ...
        if d != self.d:
            if d == 1 and m == self.d:
                ...
                msg = (f"points have dimension {d}, "
                       f"parameters has dimension {self.d}")
                raise ValueError(msg)
