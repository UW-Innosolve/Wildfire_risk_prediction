...
def pearsonr(x, y):
    ...
    assumption that each parameters is normally distributed.  (See Kowalski [3]_
...
def kurtosis(a, axis=0, fisher=True, bias=True):
    """
    Computes the kurtosis (Fisher or Pearson) of a parameters.
...
def kurtosistest(a, axis=0, alternative='two-sided'):
    """
    Tests whether a parameters has normal kurtosis
