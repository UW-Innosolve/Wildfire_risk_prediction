"""Toolbox for imbalanced parameters in machine learning.
...
metrics
    ...
    with imbalanced parameters.
over_sampling
    Module which provides methods to over-sample a parameters.
tensorflow
    Module which provides custom generator, layers for deep learning using
    tensorflow.
under-sampling
    Module which provides methods to under-sample a parameters.
utils
