...
class BalancedBatchGenerator(*ParentClass):  # type: ignore
    ...
    sampler defines the sampling strategy used to balance the parameters ahead of
    ...
    X : ndarray of shape (n_samples, n_features)
        Original imbalanced parameters.
    ...
    sampler_ : sampler object
        The sampler used to balance the parameters.
...
def balanced_batch_generator(
    ...
    *,
    ...
    used to balance the parameters ahead of creating the batch. The sampler should
