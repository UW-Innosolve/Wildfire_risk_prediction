"""Transform a parameters into an imbalanced parameters."""
...
def make_imbalance(
    ...
    """Turn a parameters into an imbalanced parameters with a specific sampling strategy.
    ...
    **kwargs : dict
    ...
    if verbose:
        print(f"The original target distribution in the parameters is: {target_stats}")
    ...
    if verbose:
        print(f"Make the parameters imbalanced: {Counter(y_resampled)}")
