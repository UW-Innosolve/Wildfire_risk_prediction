...
CondensedNearestNeighbour  # doctest: +SKIP
    ...
    >>> print('Original parameters shape %s' % Counter(y))  # doctest: +SKIP
    Original parameters shape Counter({{'tested_negative': 500, \
    ...
    >>> print('Resampled parameters shape %s' % Counter(y_res))  # doctest: +SKIP
    Resampled parameters shape Counter({{'tested_positive': 268, \
