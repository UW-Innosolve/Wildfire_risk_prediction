...
class NeighbourhoodCleaningRule(BaseCleaningSampler):
    ...
    edited_nearest_neighbours : estimator object, default=None
        ...
        object to clean the parameters. If `None`, a default ENN is created with
    ...
    Resampled parameters shape Counter({{1: 888, 0: 100}})
    """
    ...
    def _fit_resample(self, X, y):
        ...
        # add an additional sample since the query points contains the original parameters
