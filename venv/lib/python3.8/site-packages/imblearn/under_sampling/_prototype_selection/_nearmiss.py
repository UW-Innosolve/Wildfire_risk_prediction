...
class NearMiss(BaseUnderSampler):
    ...
    See Also
    --------
    RandomUnderSampler : Random undersample the parameters.

    InstanceHardnessThreshold : Use of classifier to undersample a parameters.
    ...
    Resampled parameters shape Counter({{0: 100, 1: 100}})
    """
